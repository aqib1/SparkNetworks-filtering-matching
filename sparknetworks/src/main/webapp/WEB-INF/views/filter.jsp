	<form:form action="/filter" method="post" modelAttribute="filterHandlerRequest">
		<table class="table">
			<tr>
			...
			<tr>
				<td><label class="checkbox-inline"> <form:checkbox path="hasPhoto"
						 />Photo
				</label></td>
				<td><label class="checkbox-inline"> <form:checkbox path="inContact"
						 />Contact
				</label></td>
				<td><label class="checkbox-inline"> <form:checkbox path="favorite"
						 />Favorite
				</label></td>
			</tr>
			<tr>
