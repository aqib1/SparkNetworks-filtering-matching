...
import static com.sparknetworks.filterhandler.utils.Const.INPUT_RELIGION_MAP;
...
import static com.sparknetworks.filterhandler.utils.Const.inputReligionsMap;
...
public class FilterController {
	...
	public ModelAndView home(@RequestParam(name = ERROR_ATTR_UNAUTH, required = false) String attr) {
		...
		modelAndView.addObject(INPUT_RELIGION_MAP, inputReligionsMap());
