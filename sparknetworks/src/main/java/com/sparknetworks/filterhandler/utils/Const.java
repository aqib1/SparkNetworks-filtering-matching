...
public class Const {
	...
	public static final String SPARK_FILTER_MATCHER_BACKEND = "http://spark-networks-backend/filter";
	public static final String SPARK_FILTER_MATCHER_BACKED_LOGIN = "/login";
